...
\subsection{Syntax} \label{sec:lang:syntax}
...
\subsection{Dynamic Semantics} \label{sec:lang:dynamic}
\begin{figure}
  {\small
...
%
Type 
substitution is defined at the bottom left of~\Cref{fig:opsem}
