...
\begin{proof} 
  ...
  while the general case needs a Substitution~\Cref{lem:substitutionFF}.
  %
...
\begin{proof}
  ...
  \pfcase{\fTAbs}: 
  %%
  We have $\hasftype{\tcenv', \bind{\al}{k_{\al}}, \tcenv}{\sexpr}{\sftype}$ 
  where $e \equiv \tabs{\al_0}{k'}{\sexpr'}$ 
  and $\sftype \equiv \polytype{\al_0}{k'}{\sftype'}$. 
  %
  By inversion, for any fresh type variable $\al'$,
  $\hasftype{\bind{\al'}{k'}, \tcenv', \bind{\al}{k_{\al}}, \tcenv}
        {\subst{\sexpr'}{\al_0}{\al'}}{\subst{\sftype'}{\al_0}{\al'}}$ and 
  $\isWFFT{\bind{\al'}{k'}, \tcenv', \bind{\al}{k_{\al}}, \tcenv}
        {\subst{\sftype'}{\al_0}{\al'}}{k'}$. 
  %      
  By the inductive hypothesis
  \begin{equation*}
  \hasftype{\bind{\al'}{k'}, \subst{\tcenv'}{\al}{\forgetreft{t_{\al}}}, \tcenv}
    {\subst{\subst{\sexpr'}{\al_0}{\al'}}{\al}{t_{\al}}}
    {\subst{\subst{\sftype'}{\al_0}{\al'}}{\al}{\forgetreft{t_{\al}}}}
  \end{equation*}
  and by the Substitution Lemma for $\sysf$ well-formedness judgments
  \begin{equation*}
  \isWFFT{\bind{\al'}{k'}, \subst{\tcenv'}{\al}{\forgetreft{t_{\al}}}, \tcenv}
    {\subst{\subst{\sftype'}{\al_0}{\al'}}{\al}{\forgetreft{t_{\al}}}}
    {k'}.
  \end{equation*}
  %
  Because $\al'$ is chosen to be fresh, we must have $\al\neq \al'$
  and $\al_0\neq\al'$. 
  %
  Moreover, $\forgetreft{t_{\al}}$ contains only free variables from $\Gamma$, 
  so $\subst{\subst{\sexpr'}{\al_0}{\al'}}{\al}{t_{\al}} = 
        \subst{\subst{\sexpr'}{\al}{t_{\al}}}{\al_0}{\al'}$ 
  and $\subst{\subst{\sftype'}{\al_0}{\al'}}{\al}{\forgetreft{t_{\al}}} = 
        \subst{\subst{\sftype'}{\al}{\forgetreft{t_{\al}}}}{\al_0}{\al'}$. 
  %
  Then by rule \fTAbs,
  \begin{equation*}
  \hasftype{\subst{\tcenv'}{\al}{\forgetreft{t_{\al}}}, \tcenv}
    {\tabs{\al_0}{k'}({\subst{\sexpr'}{\al}{t_{\al}}})}
    {\polytype{\al_0}{k'}({\subst{\sftype'}{\al}{\forgetreft{t_{\al}}}})}.
  \end{equation*}
  %
  By definition of substitution, we can rewrite the above as
  \begin{equation*}
    \hasftype{\subst{\tcenv'}{\al}{\forgetreft{t_{\al}}}, \tcenv}
    {\subst{(\tabs{\al_0}{k'}{\sexpr'})}{\al}{t_{\al}}}
    {\subst{(\polytype{\al_0}{k'}{\sftype'})}{\al}{\forgetreft{t_{\al}}}}
  \end{equation*}
  %
  as desired.
%% 
...
%%
\pfcase{\fIf}: We have $\sexpr \equiv \eif{\sexpr_0}{\sexpr_1}{\sexpr_2}$ 
and by inversion we have that 
$\hasftype{\tcenv', \bind{\al}{k_{\al}}, \tcenv}{\sexpr_0}{\tbool}$ 
and
$\hasftype{\tcenv', \bind{\al}{k_{\al}}, \tcenv}{\sexpr_1}{\sftype}$
and 
$\hasftype{\tcenv', \bind{\al}{k_{\al}}, \tcenv}{\sexpr_2}{\sftype}$.
By the inductive hypothesis, we have
$\hasftype{\subst{\tcenv'}{\al}{\forgetreft{\stype_{\al}}}, \tcenv}
  {\subst{\sexpr_0}{\tvar}{\stype_\tvar}}
  {\tbool}$
and
$\hasftype{\subst{\tcenv'}{\al}{\forgetreft{\stype_{\al}}}, \tcenv}
  {\subst{\sexpr_i}{\tvar}{\stype_\tvar}}
  {\subst{\sftype}{\tvar}{\forgetreft{\stype_\tvar}}}$
for each $i = 1, 2$.
%
Then by rule \fIf we have
\begin{equation*}
  \hasftype{\subst{\tcenv'}{\al}{\forgetreft{\stype_{\al}}}, \tcenv}
    {\eif{\subst{\sexpr_0}{\tvar}{\stype_\tvar}}
        {\subst{\sexpr_1}{\tvar}{\stype_\tvar}}
        {\subst{\sexpr_2}{\tvar}{\stype_\tvar}}}
    {\subst{\sftype}{\tvar}{\forgetreft{\stype_\tvar}}}
\end{equation*}
%
By the definition of substitution, we have the equality
$\eif{\subst{\sexpr_0}{\tvar}{\stype_\tvar}}
  {\subst{\sexpr_1}{\tvar}{\stype_\tvar}}
  {\subst{\sexpr_2}{\tvar}{\stype_\tvar}}
  = \subst{(\eif{\sexpr_0}{\sexpr_1}{\sexpr_2})}{\tvar}{\stype_\tvar}$,
which gives us the desired judgment.  
%%
\end{proof}  
...
\section*{Acknowledgements for Chapter 4}
%
